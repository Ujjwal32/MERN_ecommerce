...
function TableComponents() {
  ...
  const total =
    cartItems &&
    cartItems.reduce((accumulator, single) => {
      ...
      <>
                  ...
                  <TableRow key={single._id}>
                    ...
                    <TableCell align="right" id={single._id}>
                      ...
                      <button
                        ...
                        disabled={single.quantity === 1 && true}
                      >
                        -
                      </button>
                    </TableCell>
                    <TableCell align="right">
                      Rs. {single.quantity * single.price}
                    </TableCell>
        ...
        <div className={classes.bottomInfo}>
          <div className={classes.butButtons}>
            ...
            <Link to="/checkout">
              <Button color="primary" variant="contained" disableRipple={true}>
                Place Order
              </Button>
            </Link>
          </div>
          <Paper className={classes.total}>
            ...
            <Typography variant="h6" gutterBottom={true}>
              Amount to pay: Rs. {total + total * 0.15}
            </Typography>
          </Paper>
        </div>
      </>
